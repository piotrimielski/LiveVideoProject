...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    public static void loadLibrariesOnce(IjkLibLoader libLoader) {
        synchronized (IjkMediaPlayer.class) {
            if (!mIsLibLoaded) {
                ...
                libLoader.loadLibrary("ffmpegijk");
                libLoader.loadLibrary("renderersdl");
                libLoader.loadLibrary("mad");
                libLoader.loadLibrary("madplayer");
    ...
    private native void _start(Context context) throws IllegalStateException;

    private native String _ccas();
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case MEDIA_TIMED_TEXT:
                    ...
                    return;
                case MEDIA_NOP: // interface test message - ignored
                    break;
    ...
    public static class DefaultMediaCodecSelector implements OnMediaCodecSelectListener {
        ...
        public String onMediaCodecSelect(IMediaPlayer mp, String mimeType, int profile, int level) {
            ...
            if (bestCodec.mCodecInfo.getName().contains("Exynos") && candidateCodecList.size() > 1) {
                bestCodec = candidateCodecList.get(1);
            } else if (bestCodec.mRank < IjkMediaCodecInfo.RANK_LAST_CHANCE) {
    ...
    public native void _setMed(int m, Context context);
